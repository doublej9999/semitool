...
/**
 * Heavy UI for the Engineering Handbook, lazily loaded by
 * `EngineeringHandbookModal` (next/dynamic) so it stays out of every page
 * bundle. The modal wrapper owns the open state, the toolbar trigger button,
 * and the Escape/scroll-lock listener; this panel renders the drawer itself.
 */
...
interface EngineeringHandbookPanelProps {
  open: boolean;
  onClose: () => void;
}

export default function EngineeringHandbookPanel({ open, onClose }: EngineeringHandbookPanelProps) {
