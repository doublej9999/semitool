...
/**
 * Heavy UI for the Fab Scratchpad (unit converters, quick math, cleanroom
 * notes), lazily loaded by `FabScratchpadModal` (next/dynamic) so it stays out
 * of every page bundle. The modal wrapper owns the open state, the toolbar
 * trigger button, and the Escape/scroll-lock listener.
 */
...
interface FabScratchpadPanelProps {
  open: boolean;
  onClose: () => void;
}

export default function FabScratchpadPanel({ open, onClose }: FabScratchpadPanelProps) {
