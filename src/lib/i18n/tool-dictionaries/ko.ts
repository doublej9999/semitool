...
export const ko: Record<string, ToolTranslation> = {
  ...
  "/tools/layout-parasitics-calculator": {
    "name": "IC 레이아웃 기생 파라미터 추정기",
    "description": "배선 기하 구조로부터 인터커넥트 저항, 평판 및 프린지 커패시턴스, IR 드롭, RC 지연을 추정하는 테이프아웃 전 고전적 검증 도구입니다. Cu/Al/텅스텐/폴리 실리콘의 저항률 온도 보정을 지원합니다.",
    "keywords": [
      "레이아웃",
      "기생 커패시턴스",
      "기생 저항",
  ...
  "/tools/drc-rule-checker": {
    "name": "DRC 설계 규칙 자가 점검",
    "description": "공정 노드를 선택하면 층별 일반적인 설계 규칙(최소 선폭, 간격, 피치, 접촉/비아 인클로저, 최소 면적)을 보여주고, 그려진 레이아웃 치수가 규칙을 충족하는지 통과/위반과 여유값으로 확인합니다 — 경험적 참고값이며 파운드리 DRC 덱이 아닙니다.",
    "keywords": [
      "설계 규칙",
      "DRC",
      "선폭",
