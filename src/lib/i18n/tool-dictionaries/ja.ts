...
export const ja: Record<string, ToolTranslation> = {
  ...
  "/tools/drc-rule-checker": {
    "name": "DRC設計ルール簡易チェッカー",
    "description": "プロセスノードを選択すると各層の典型的な設計ルール（最小幅、間隔、ピッチ、コンタクト/ビア囲み量、最小面積）を表示し、描画したレイアウト寸法がルールを満たすか合格/違反とマージンで判定します — 目安の参考値であり、ファウンドリの DRC デッキではありません。",
    "keywords": [
      "設計ルール",
      "DRC",
      "幅",
