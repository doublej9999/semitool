...
export const en: Translations = {
  ...
  "gloveModeOn": "ON",
  "gloveModeOff": "OFF",
  "scHandbook": "Engineering Handbook",
  "scTraveler": "Engineering Run-Card Traveler",
  "scGenealogy": "Lot Split Genealogy",
  "scWorkspace": "Film Stack & Warp Workspace",
  "scScratchpad": "Fab Scratchpad",
  "scPalette": "Command Palette",
  "scShowShortcuts": "Show Shortcuts",

  // Process workflow bar
  "wfCustomFlows": "Custom flows",
  "wfNewCustomFlow": "New custom flow",
  "wfFlowNameLabel": "Flow name",
  "wfPickToolsLabel": "Pick a tool to append a step",
  "wfSaveFlow": "Save flow",
  "wfCancelFlow": "Cancel",
  "wfDeleteFlow": "Delete this flow",
  "wfStepsDone": "{done}/{total} done",
  "wfToggleStep": "Toggle step completion",
  "inputs": "Inputs",
  "results": "Results",
  ...
  // Fab Workspace
  "fabWsTitle": "Wafer Film Stack & Fab Project Workspace",
  "fabWsSubtitle": "Unified multi-layer stack, extended Stoney warp & thermal budget ledger",
  "fabWsTemplates": "Templates",
  "fabWsExport": "Export",
  "fabWsExportTitle": "Export Project JSON",
  "fabWsImport": "Import",
  "fabWsImportTitle": "Import Project JSON",
  "fabWsReset": "Reset",
  "fabWsResetTitle": "Reset Workspace",
  "fabWsTotalFilmThick": "Total Film Thick.",
  "fabWsNetAvgStress": "Net Avg. Stress",
  "fabWsWaferBowWarp": "Wafer Bow / Warp",
  "fabWsCharDiffLength": "Char. Diffusion Length",
  "fabWsLayerCrossSection": "Layer Cross-Section",
  "fabWsNoFilmsVisual": "(No deposited films)",
  "fabWsSubstrateMaterial": "Substrate Material",
  "fabWsWaferDiameter": "Wafer Diameter",
  "fabWsSubstrateThick": "Substrate Thick.",
  "fabWsFilmStackSteps": "Film Stack Steps",
  "fabWsAddLayer": "Add Layer",
  "fabWsEmptyStackPrompt": "No films in stack. Click \"+ Add Layer\" or pick a template above.",
  "fabWsEditLayerParams": "Edit Selected Layer Parameters",
  "fabWsLayerName": "Layer Name",
  "fabWsMaterial": "Material",
  "fabWsThickness": "Thickness (nm)",
  ...
  "fabWsStressNeutral": "neutral",
  "fabWsSevereWarp": "Severe wafer warp (|Bow| = {bow} µm > 150 µm). High risk of electrostatic/vacuum chuck clamping failure and wafer breakage during transfer!",
  "fabWsModerateWarp": "Moderate wafer bow (|Bow| = {bow} µm > 60 µm). May induce lithography scanner focus depth (DoF) runout and CD distortion.",
  "fabWsSubSi100": "Silicon (100)",
  "fabWsSubSi111": "Silicon (111)",
  "fabWsSubSiC4h": "4H-Silicon Carbide (4H-SiC)",
  "fabWsSubGaas": "Gallium Arsenide (GaAs)",
  "fabWsSubSapphire": "Sapphire (Al2O3 c-plane)",
  "fabWsSubGan": "Gallium Nitride (GaN)",
  "fabWsSubFusedSilica": "Fused Silica / Quartz",
  "fabWsLinkedLot": "Linked Lot",
