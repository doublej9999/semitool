...
export const zhCN: Translations = {
  ...
  "gloveModeOn": "已开启",
  "gloveModeOff": "已关闭",
  "scHandbook": "打开晶圆制造工程手册",
  "scTraveler": "开启车间随工单 / 打印",
  "scGenealogy": "晶圆批次谱系与分批图",
  "scWorkspace": "膜层堆叠与晶圆翘曲工作区",
  "scScratchpad": "快捷工艺草稿本 / 备忘",
  "scPalette": "聚焦指令调色板 / 工具搜索",
  "scShowShortcuts": "显示本快捷键帮助",

  // Process workflow bar
  "wfCustomFlows": "自定义工艺流",
  "wfNewCustomFlow": "新建自定义工艺流",
  "wfFlowNameLabel": "工艺流名称",
  "wfPickToolsLabel": "选择工具以添加步骤",
  "wfSaveFlow": "保存工艺流",
  "wfCancelFlow": "取消",
  "wfDeleteFlow": "删除该工艺流",
  "wfStepsDone": "已完成 {done}/{total}",
  "wfToggleStep": "切换步骤完成状态",
  "inputs": "输入参数",
  "results": "计算结果",
  ...
  // Fab Workspace
  "fabWsTitle": "晶圆工艺堆叠与虚拟工程工作区",
  "fabWsSubtitle": "统一多层几何厚度、Stoney 综合应力翘曲与热预算跟踪",
  "fabWsTemplates": "预置配方模板",
  "fabWsExport": "导出",
  "fabWsExportTitle": "导出工程文件 (.json)",
  "fabWsImport": "导入",
  "fabWsImportTitle": "导入工程文件 (.json)",
  "fabWsReset": "重置",
  "fabWsResetTitle": "重置工作区",
  "fabWsTotalFilmThick": "总薄膜厚度",
  "fabWsNetAvgStress": "平均等效应力",
  "fabWsWaferBowWarp": "晶圆矢高 / 翘曲",
  "fabWsCharDiffLength": "特征热扩散长度",
  "fabWsLayerCrossSection": "薄膜层叠剖面图 (Cross-Section)",
  "fabWsNoFilmsVisual": "（暂无薄膜沉积）",
  "fabWsSubstrateMaterial": "衬底材料",
  "fabWsWaferDiameter": "晶圆直径",
  "fabWsSubstrateThick": "衬底厚度",
  "fabWsFilmStackSteps": "薄膜工步序列",
  "fabWsAddLayer": "沉积新薄膜",
  "fabWsEmptyStackPrompt": "当前晶圆尚无薄膜，请点击右上角「沉积新薄膜」或加载预置配方。",
  "fabWsEditLayerParams": "选定层工艺与物理参数编辑",
  "fabWsLayerName": "层名称",
  "fabWsMaterial": "材料配方",
  ...
  "fabWsStressNeutral": "中性应力 (Neutral)",
  "fabWsSevereWarp": "晶圆翘曲严重 (|矢高| = {bow} µm > 150 µm)。静电/真空吸盘有脱附失夹风险，机械手搬运易碎裂！",
  "fabWsModerateWarp": "晶圆中度翘曲 (|矢高| = {bow} µm > 60 µm)。可能导致光刻机曝光焦深 (DoF) 超差及线宽失真。",
  "fabWsSubSi100": "单晶硅 (100)",
  "fabWsSubSi111": "单晶硅 (111)",
  "fabWsSubSiC4h": "碳化硅 (4H-SiC)",
  "fabWsSubGaas": "砷化镓 (GaAs)",
  "fabWsSubSapphire": "蓝宝石 (c面 Al2O3)",
  "fabWsSubGan": "氮化镓 (GaN)",
  "fabWsSubFusedSilica": "石英 / 熔融二氧化硅",
  "fabWsLinkedLot": "关联批次",
  "fabWsNoLotLinked": "尚未关联谱系批次 — 请打开批次谱系 (Alt+G)",
  "fabWsBranchesLabel": "{count} 个分批",
  "fabWsLinkedMetrology": "关联量测数据",
  "fabWsNoMetrology": "尚未导入量测数据",

  // Lot Genealogy
  "genealogyModalTitle": "晶圆批次谱系与多工序随工单 (Lot Genealogy)",
  "genealogyNewLot": "新建批次",
  "genealogySplitBranches": "工艺分支:",
  "genealogySplitWafers": "分批晶圆 (Split)",
  "genealogyLogActiveTool": "记录当前计算器工序",
  "genealogyAssignedWafers": "包含晶圆槽位:",
  "genealogySteps": "已执行工序:",
  "genealogyMetrologyPass": "量测合格率:",
  "genealogyCreateSplitTitle": "创建分批分支 (DoE Split)",
  "genealogySplitNameLabel": "分批名称 (Split Name):",
  "genealogySplitSlotsLabel": "晶圆槽位 (Wafers, 如 13-25 或 13,14,15):",
  "genealogyCancel": "取消",
  "genealogyConfirmSplit": "确认分批",
  "genealogyEmptyTitle": "该分支尚无工序执行记录",
  "genealogyEmptyDesc": "点击右上角“记录当前计算器工序”，将当前界面的工艺参数与量测结果永久写入随工单。",
  "genealogyRecordInitial": "记录第一道工序",
  "genealogyRecipeParams": "工艺配方参数 (Recipe):",
  "genealogyMetrologyVerification": "在机量测数据 (In-line Metrology):",
  "genealogyPromptLotId": "输入新批次号 (Lot ID):",
  "genealogyPromptPartNo": "输入产品料号 (Part Number):",
  "genealogyCurrentProcessStep": "当前工艺节点",
  "genealogyBusNotes": "通过 SemiTools 数据总线采集",
  "genealogyProvideSplitName": "请输入分支名称",
  "genealogyInvalidSlots": "所选晶圆编号无效，必须是当前分支的部分晶圆",
  "genealogyWafersUnit": "片晶圆",
